...
print("functions of a strings")




print(len(abc))
print(abc.endswith("m"))
print(abc.startswith("M"))

print(xyz.replace("Pakistan", "turkey "))
...
# String format()
text = "My name is {} and im selected for the course training"
username=input("enter name ")
print(text.format(username))  # Output: 'My name is Syed Muhammad Arsalan Shah'

# String format_map()
data = {"name": "Syed" , "age": 19}
